...
class FullTimeSalariedEmployee(Employee):
    ...
    def __init__(self, first_name, last_name, emp_id,  year_experience, annual_salary):
        super().__init__(first_name, last_name, emp_id, year_experience)
        self.annual_salary=annual_salary
...
class HourlyContractor(Employee):
    ...
    def __init__(self, first_name, last_name, emp_id, years_experience, hourly_rate):
        super().__init__(first_name, last_name, emp_id, years_experience)
...
class FullTimeSalariedSalesEmployee(FullTimeSalariedEmployee):
    ...
    def __init__(self, first_name, last_name, emp_id, years_experience, annual_salary, commission_percentage):
        super().__init__(first_name, last_name, emp_id, years_experience, annual_salary)
        self.annual_salary=annual_salary
