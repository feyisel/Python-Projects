...
class Patient:
    ...
    def __init(self, first_name, last_name, address, phone_number, total_charges):
...
class PaymentProcessor:
    def __init(self, list_of_patients):
...
def main():
    ...
    patient1 = Patient("John", "sam", "1505 Main St, Main, CA", "111-222-3333", 10000)
    patient1.doctor_discount = 0
    patient1.hospital_discount = 0
    patient1.single_payment_discount = 5
    patient2 = Patient("Matt", "Simon", "1022 Main St, Main, CA", "111-222-3333", 50000)
    ...
    patient3.doctor_discount = 10
    patient3.hospital_discount = 5
    patient3.single_payment_discount = 1
